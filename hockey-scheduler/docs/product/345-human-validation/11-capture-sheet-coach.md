...
| Participant code (anonymous — `C-01`, `C-02`, … ; see the privacy rules below) | |
...
`C-01` for the first Coach participant, `C-02` for the second, and so
...
consent, so the join from `C-01` to a person does exist; it simply never enters
