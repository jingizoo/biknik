...
// context-scoped read contract is `RouteSpec.context_read_fence` in
// `web/route_registry.py`, which today marks five routes: the two Setup Season
// reads this helper is used for, plus `GET /api/scheduler/scenarios/<id>` and
// both operator standings shapes. Those last three are ordered SERVER-SIDE by
